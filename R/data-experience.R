...
#' cell-level `loss_incr` / `premium_incr` values are randomly drawn.
#' The SUR coverage carries a synthetic 2024-04 cohort regime break
#' (LR halved) so the `detect_regime()` example has a clear shift to
#' find.
#'
