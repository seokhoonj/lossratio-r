# Regime break 기반 hybrid 필터링

> 영어 원본 보기: [Hybrid filtering via regime
> break](https://seokhoonj.github.io/lossratio/ko/regime-break.md)
...
| `CohortRegime` 객체 | [`detect_cohort_regime()`](https://seokhoonj.github.io/lossratio/ko/reference/detect_cohort_regime.md) 결과를 직접 전달 |
...
hybrid 패널은 사용자가 의도한 dev-축 split — ED 쪽은 수평 컷, CL 쪽은
대각선 컷이 $`k^*`$ 에서 만나는 사다리꼴 합집합 — 을 그대로 시각화한다.
...
drift 가 -4.50pp 에서 +0.69pp 로 거의 0 에 수렴하고 overall mean 도
편향이 사라진다. 사용자가 의도한 “ED 는 수평 컷, CL 은 대각선 컷” 이라는
dev-축 split 이 정확히 구현된 결과다.

데이터 사용 영역의 시각적 비교는 위 4-panel 그림 참조. full 은 모든 셀,
recent 는 최근 대각선 띠, hybrid 는 좌하단의 post-break 사다리꼴 +
우상단의 최근 대각선 띠라는 두 영역의 합집합으로 나타난다.
...
named list 입력을 지원할 수 있으나, 현재는 scalar/vector/`CohortRegime`
세 형태만 동작한다.
...
- [`fit_lr`](https://seokhoonj.github.io/lossratio/ko/reference/fit_lr.md)
  — 손해율 추정 통합 인터페이스.
- [백테스트
  vignette](https://seokhoonj.github.io/lossratio/ko/articles/backtest-ko.md)
