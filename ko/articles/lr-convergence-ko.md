...
| $`k^*`$ | 성숙점 ([`find_ata_maturity()`](https://seokhoonj.github.io/lossratio/ko/reference/find_ata_maturity.md) 산출). 후보 $`v`$ 의 하한 |
| $`k^{**}`$ | 수렴점. [`find_lr_convergence()`](https://seokhoonj.github.io/lossratio/ko/reference/find_lr_convergence.md) 가 반환하는 값 |
