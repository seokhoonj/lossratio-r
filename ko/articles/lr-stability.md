...
| [`find_lr_stability()`](https://seokhoonj.github.io/lossratio/ko/reference/find_lr_stability.md) ($`k_0`$) | When does the LR estimate stop revising? | a dev value | development period |
