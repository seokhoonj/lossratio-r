...
#>  $ incr_prem: num  27993106 29183931 29401966 26570540 27471886 ...
...
names(tri)
#>  [1] "coverage"        "n_cohorts"       "cohort"          "dev"            
#>  [5] "loss"            "incr_loss"       "prem"            "incr_prem"      
#>  [9] "lr"              "incr_lr"         "margin"          "incr_margin"    
#> [13] "profit"          "incr_profit"     "loss_share"      "incr_loss_share"
#> [17] "prem_share"      "incr_prem_share"
```

[`as_triangle()`](https://seokhoonj.github.io/lossratio/ko/reference/as_triangle.md):

- validates required columns (`cy_m`, `uy_m`, `incr_loss`, `incr_prem`)
  and coerces them to the expected types,
...
- adds derived metrics (`margin` / `incr_margin`, `lr` / `incr_lr`,
  proportions),
