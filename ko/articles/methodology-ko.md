...
> rationale](https://seokhoonj.github.io/lossratio/ko/methodology.md)
...
## 4. lossratio 의 *여섯 가지 적응* — 각 ↔︎ 도메인 issue 매핑
...
| 도구 | 진단 대상 | 출력 |
|----|----|----|
| [`detect_maturity()`](https://seokhoonj.github.io/lossratio/ko/reference/detect_maturity.md) | dev 축 — ATA 인자(age-to-age factor) 가 *수렴하는 dev* | `Maturity` 객체 + 코호트 별 $`k^*`$ |
| [`detect_regime()`](https://seokhoonj.github.io/lossratio/ko/reference/detect_regime.md) | cohort 축 — *구조적 변화점* (체제 변화) | `Regime` 객체 + 변화 시점 |
| [`detect_convergence()`](https://seokhoonj.github.io/lossratio/ko/reference/detect_convergence.md) | 예측 손해율 *수렴점* ($`k^{**}`$) | `Convergence` 객체 + holdout 별 적합 |
| [`backtest()`](https://seokhoonj.github.io/lossratio/ko/reference/backtest.md) | calendar diagonal hold-out | 실제 vs 예측, cohort × dev × calendar 별 A/E |
| [`bootstrap()`](https://seokhoonj.github.io/lossratio/ko/reference/bootstrap.md) | 변동성 — cell / link / parametric paradigm | pseudo-triangle + percentile CI |
...
- **BF / Cape Cod 도입** — prior-anchored family 의 두 method (section 6
  참조). BF 는 *외부 prior ELR*, Cape Cod 는 *payout-weighted 데이터
...
- [`vignette("convergence")`](https://seokhoonj.github.io/lossratio/ko/articles/convergence.md)
  — 예측 손해율 *수렴점* 진단.
- [`vignette("triangle-link-and-maturity")`](https://seokhoonj.github.io/lossratio/ko/articles/triangle-link-and-maturity.md)
  — Triangle / Link / Maturity 의 데이터 흐름.
