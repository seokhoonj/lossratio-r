...
| [`find_lr_stability()`](https://seokhoonj.github.io/lossratio/ko/reference/find_lr_stability.md) ($`k_0`$) | LR 추정이 갱신을 멈추는 시점? | dev 값 | 발전 기간 |
...
2.  각 동질 그룹에서
    [`find_ata_maturity()`](https://seokhoonj.github.io/lossratio/ko/reference/find_ata_maturity.md)
    로 $`k^*`$ 산출.
3.  [`find_lr_stability()`](https://seokhoonj.github.io/lossratio/ko/reference/find_lr_stability.md)
