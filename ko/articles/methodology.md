...
> 근거](https://seokhoonj.github.io/lossratio/ko/articles/articles/methodology-ko.md)
...
- **Levelled premium** — Non-renewable contracts charge a level premium
  ...
  not premium; the *period risk premium* (morbidity rate × sum insured ×
...
|----|----|----|
| [`detect_maturity()`](https://seokhoonj.github.io/lossratio/ko/reference/detect_maturity.md) | dev axis — where age-to-age factors stabilise | `Maturity` object with per-cohort $`k^*`$ |
| [`detect_regime()`](https://seokhoonj.github.io/lossratio/ko/reference/detect_regime.md) | cohort axis — structural break points | `Regime` object with change dates |
| [`detect_convergence()`](https://seokhoonj.github.io/lossratio/ko/reference/detect_convergence.md) | projected loss-ratio stability point $`k^{**}`$ | `Convergence` object with per-holdout fits |
| [`backtest()`](https://seokhoonj.github.io/lossratio/ko/reference/backtest.md) | calendar-diagonal hold-out | actual vs expected, by cohort × dev × calendar |
| [`bootstrap()`](https://seokhoonj.github.io/lossratio/ko/reference/bootstrap.md) | variance — cell / link / parametric paradigm | pseudo-triangles + percentile CI |
...
- **Frequency-severity decomposition** —
  `fit_ed(loss = "claim_count", premium = "insureds")` for frequency,
