...
- recent:
  ...
  filter; see
  [`.apply_recent_filter()`](https://seokhoonj.github.io/lossratio-r/ko/reference/dot-apply_recent_filter.md)).
...
- regime:
  ...
  via
  [`.resolve_regime()`](https://seokhoonj.github.io/lossratio-r/ko/reference/dot-resolve_regime.md).
