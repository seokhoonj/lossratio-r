...
- [`print(`*`<CapeCodFit>`*`)`](https://seokhoonj.github.io/lossratio/ko/reference/print.CapeCodFit.md)
  :
...
- [`summary(`*`<CapeCodFit>`*`)`](https://seokhoonj.github.io/lossratio/ko/reference/summary.CapeCodFit.md)
  :
