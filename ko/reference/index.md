...
`fit_loss` (loss 측 ed/cl/sa/bf/cc), `fit_exposure` (exposure 측 ed/cl).
...
- [`plot(`*`<ExposureFit>`*`)`](https://seokhoonj.github.io/lossratio/ko/reference/plot.ExposureFit.md)
...
- [`plot_triangle(`*`<ExposureFit>`*`)`](https://seokhoonj.github.io/lossratio/ko/reference/plot_triangle.ExposureFit.md)
