...
- [`derive_grain_columns()`](https://seokhoonj.github.io/lossratio-r/ko/reference/derive_grain_columns.md)
...
`fit_sa` (성숙점 기준 ED + CL 합성 — stage-adaptive). ELR 기반 reserve
모형: `fit_bf` (외부 prior 를 받는 Bornhuetter-Ferguson), `fit_cc`
(데이터에서 pooled ELR 을 추정하는 Cape Cod). Role dispatcher:
`fit_loss` (loss 측 ed/cl/sa/bf/cc), `fit_premium` (premium 측 ed/cl).
합성: `fit_ratio` (손해율 통합 인터페이스, delta-method SE). 모두 결과
객체에 `$full` projection table 을 보유.
...
`loss_regime` / `premium_regime` 인자에 들어갈 수동 (`_at()`) 혹은
...
- [`detect_regime()`](https://seokhoonj.github.io/lossratio-r/ko/reference/detect_regime.md)
  [`print(`*`<Regime>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/detect_regime.md)
  [`summary(`*`<Regime>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/detect_regime.md)
  [`print(`*`<summary.Regime>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/detect_regime.md)
...
- [`regime_spec()`](https://seokhoonj.github.io/lossratio-r/ko/reference/regime_spec.md)
  : Build a lazy regime detection spec

## 부트스트랩

cohort × dev 단위 표준오차 분해를 시뮬레이션으로 산출 (피타고라스 분해 —
parameter + process). 반환 객체는 `fit_loss` / `fit_premium` /
...
- [`detect_convergence()`](https://seokhoonj.github.io/lossratio-r/ko/reference/detect_convergence.md)
...
- [`backtest()`](https://seokhoonj.github.io/lossratio-r/ko/reference/backtest.md)
  [`print(`*`<Backtest>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/backtest.md)
  [`summary(`*`<Backtest>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/backtest.md)
  [`print(`*`<summary.Backtest>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/backtest.md)
...
[`render()`](https://seokhoonj.github.io/lossratio-r/ko/reference/render.md)
는 data frame 과 `Triangle` 객체용 콘솔 테이블 렌더러.
...
- [`plot(`*`<BFFit>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/plot.BFFit.md)
...
- [`plot(`*`<CCFit>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/plot.CCFit.md)
  : Plot a Cape Cod fit

- [`plot(`*`<CLFit>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/plot.CLFit.md)
  : Plot a chain ladder fit

- [`plot(`*`<Calendar>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/plot.Calendar.md)
  : Plot calendar-based development statistics

- [`plot(`*`<Convergence>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/plot.Convergence.md)
  : Plot the Convergence diagnostic

- [`plot(`*`<EDFit>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/plot.EDFit.md)
  : Plot an ED fit

- [`plot(`*`<IntensityFit>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/plot.IntensityFit.md)
...
- [`plot(`*`<PremiumFit>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/plot.PremiumFit.md)
  : Plot an premium fit

- [`plot(`*`<RatioFit>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/plot.RatioFit.md)
  : Plot a loss ratio fit

- [`plot(`*`<Regime>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/plot.Regime.md)
  : Plot a cohort regime detection result

- [`plot(`*`<RegimeOptimalWindow>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/plot.RegimeOptimalWindow.md)
...
- [`plot(`*`<Triangle>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/plot.Triangle.md)
...
- [`plot_triangle(`*`<BFFit>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/plot_triangle.BFFit.md)
...
- [`plot_triangle(`*`<CCFit>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/plot_triangle.CCFit.md)
  : Plot a Cape Cod fit as a triangle table

- [`plot_triangle(`*`<CLFit>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/plot_triangle.CLFit.md)
  : Plot a chain ladder fit as a triangle table

- [`plot_triangle(`*`<EDFit>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/plot_triangle.EDFit.md)
  : Triangle heatmap for an ED fit

- [`plot_triangle(`*`<IntensityFit>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/plot_triangle.IntensityFit.md)
...
- [`plot_triangle(`*`<PremiumFit>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/plot_triangle.PremiumFit.md)
  : Plot an premium fit as a triangle table

- [`plot_triangle(`*`<RatioFit>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/plot_triangle.RatioFit.md)
  : Plot loss ratio projection as a triangle heatmap

- [`plot_triangle(`*`<SAFit>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/plot_triangle.SAFit.md)
  : Plot a stage-adaptive fit as a triangle table

- [`plot_triangle(`*`<Triangle>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/plot_triangle.Triangle.md)
  : Plot development values as a triangle table

- [`plot_triangle(`*`<TriangleValidation>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/plot_triangle.TriangleValidation.md)
  : Triangle-heatmap view of dev-sequence gaps

- [`render()`](https://seokhoonj.github.io/lossratio-r/ko/reference/render.md)
  [`print(`*`<Triangle>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/render.md)
...
- [`print(`*`<ATASummary>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/print.ATASummary.md)
  :

  Print method for `ATASummary`

- [`print(`*`<BFFit>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/print.BFFit.md)
  :

  Print method for `BFFit`

- [`print(`*`<BootstrapTriangle>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/print.BootstrapTriangle.md)
  : Print method for BootstrapTriangle

- [`print(`*`<CCFit>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/print.CCFit.md)
  :

  Print method for `CCFit`

- [`print(`*`<CLFit>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/print.CLFit.md)
  :

  Print a `CLFit` object

- [`print(`*`<EDFit>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/print.EDFit.md)
  :

  Print an `EDFit` object

- [`print(`*`<EDSummary>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/print.EDSummary.md)
  :

  Print method for `EDSummary`

- [`print(`*`<IntensityFit>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/print.IntensityFit.md)
  :

  Print method for `IntensityFit`

- [`print(`*`<LossFit>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/print.LossFit.md)
  :

  Print method for `LossFit`

- [`print(`*`<PremiumFit>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/print.PremiumFit.md)
  :

  Print method for `PremiumFit`

- [`print(`*`<RatioFit>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/print.RatioFit.md)
  :

  Print an `RatioFit` object

- [`print(`*`<SAFit>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/print.SAFit.md)
  :
...
- [`summary(`*`<ATAFit>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/summary.ATAFit.md)
  :

  Summary method for `ATAFit`

- [`summary(`*`<BFFit>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/summary.BFFit.md)
  :

  Summary method for `BFFit`

- [`summary(`*`<CCFit>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/summary.CCFit.md)
  :
...
- [`summary(`*`<Calendar>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/summary.Calendar.md)
...
- [`summary(`*`<LossFit>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/summary.LossFit.md)
  :

  Summary method for `LossFit`

- [`summary(`*`<PremiumFit>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/summary.PremiumFit.md)
  :

  Summary method for `PremiumFit`

- [`summary(`*`<RatioFit>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/summary.RatioFit.md)
  :

  Summary method for `RatioFit`

- [`summary(`*`<SAFit>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/summary.SAFit.md)
  :

  Summary method for `SAFit`

- [`summary(`*`<Total>`*`)`](https://seokhoonj.github.io/lossratio-r/ko/reference/summary.Total.md)
  :
...
- [`longer()`](https://seokhoonj.github.io/lossratio-r/ko/reference/longer.md)
  : Reshape an object to long form (S3 generic)
- [`mask_triangle()`](https://seokhoonj.github.io/lossratio-r/ko/reference/mask_triangle.md)
  : Mask the last N calendar diagonals from a Triangle

## 데이터셋

- [`experience`](https://seokhoonj.github.io/lossratio-r/ko/reference/experience.md)
