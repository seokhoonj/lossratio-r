...
- boots:
  ...
  [`.resolve_bootstrap_bf()`](https://seokhoonj.github.io/lossratio-r/ko/reference/dot-resolve_bootstrap_bf.md).

- priors:

  Per-cohort ELR table (see
  [`.resolve_bf_prior()`](https://seokhoonj.github.io/lossratio-r/ko/reference/dot-resolve_bf_prior.md)).
