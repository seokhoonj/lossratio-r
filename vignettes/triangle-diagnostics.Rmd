...
`find_maturity()` takes a `Triangle` directly — the underlying
...
`find_maturity()` is also called internally by `fit_ata()` and
...
6. `find_maturity()` — verify maturity detection produces a
