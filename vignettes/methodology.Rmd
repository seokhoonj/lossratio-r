...
of the true ultimate. Tail extrapolation is needed. Sherman (1984)'s
log-linear curve fit (exponential or inverse-power form) is the
planned default:
...
Domain expertise and sensitivity analysis are essential. Clark
(2003)'s parametric growth curve (loglogistic / Weibull MLE) is a
candidate advanced option.
