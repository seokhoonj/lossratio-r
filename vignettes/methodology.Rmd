...
of the true ultimate. Tail extrapolation is needed. The planned
`fit_tail()` family covers two paradigms: Sherman (1984)'s log-linear
curve fit (exponential / inverse-power / Weibull forms — descriptive),
and Clark (2003)'s parametric growth curve (loglogistic / Weibull MLE —
stochastic). Both reachable through one entry:
...
Domain expertise and sensitivity analysis are essential — running both
the Sherman descriptive fit and the Clark MLE form on the same series
is a natural cross-check.
