...
`value_var = "lr"`. The loss ratio is unitless and dimension-free
...
> take a `value_var` at all — it always projects `loss`, `premium`, and
> `lr` jointly — and `value_var` here only chooses which of those
...
bt_loss <- backtest(tri_sur, holdout = 6L, value_var = "loss")
bt_rp   <- backtest(tri_sur, holdout = 6L, value_var = "premium")
