...
| `"exposure"` | `fit_exposure()`  | `exposure_method` | `exposure_proj`   |
...
afterwards. The `exposure_method` argument selects the premium
...
`target = "loss"` or `target = "exposure"` to score the corresponding
