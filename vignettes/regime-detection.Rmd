...
below has a clear shift for `detect_cohort_regime()` to find.
...
`detect_cohort_regime()` answers both questions in one call — grouping
...
`detect_cohort_regime()` is a *preprocessing diagnostic*, not a
