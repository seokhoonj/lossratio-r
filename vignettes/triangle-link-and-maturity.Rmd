...
```{r}
la <- list(size = 2.5)                                       # smaller label size
plot_triangle(tri, value_var = "lr",      label_args = la)   # cumulative lr
plot_triangle(tri, value_var = "lr_incr", label_args = la)   # incremental lr
...
plot_triangle(tri_q, label_style = "detail",
              label_args = la)                          # ratio + (loss / premium)
```
...
plot_triangle(ata_q, label_style = "detail",
              label_args = la)                    # factor + (loss / premium)
```
