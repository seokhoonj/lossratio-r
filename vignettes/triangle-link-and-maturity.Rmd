...
```{r}
ata <- build_link(tri, value_var = "loss")
...
ata_q <- build_link(tri_q, value_var = "loss")
...
```{r}
ed <- build_link(tri, value_var = "loss", premium_var = "premium")
...
```{r, eval = FALSE}
fit_ata(tri, value_var = "loss",
        maturity_args = list(cv_threshold = 0.08, min_run = 2L))

fit_cl(tri, value_var = "loss",
...
detect_maturity(tri_all, value_var = "loss")
```
...
```{r}
plot(build_link(tri_all, value_var = "loss"), type = "cv")
```
...
```{r}
fit_ata(tri, value_var = "loss", alpha = 1, recent = 12)  # last 12 calendar diagonals
fit_cl(tri, value_var = "loss", recent = 12)
