...
as a plain cohort cut. The worker `fit_ata`, `fit_ed` keep the older
`regime_break` argument and accept raw `Date` / character / vector input
in addition to a `Regime` object.
