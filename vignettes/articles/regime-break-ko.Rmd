...
대각선 단위 컷은 어린 dev 영역까지 흘러들어가, 사용자가 보기에는 "이미
...
- [`fit_lr`](../reference/fit_lr.html) — 손해율 추정 통합 인터페이스.
- [백테스트 vignette](backtest-ko.html) — `recent`, `regime_break` 가
  결과에 미치는 영향을 진단하는 도구.
- [`detect_cohort_regime`](../reference/detect_cohort_regime.html) —
