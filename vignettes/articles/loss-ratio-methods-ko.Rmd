---
title: "손해율 예측 방법론: SA, ED, CL"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{손해율 예측 방법론: SA, ED, CL}
...
- $f_k = C^L_{k+1} / C^L_k$ — 발달계수(age-to-age factor, ATA)
...
- **성숙 이전**: 손해 추정치가 익스포저에 비례한다.
  초기 $f_k$ 가 노이즈로 폭주하는 문제를 회피한다.
- **성숙 이후**: 코호트 자체의 관측 수준을 보존한다. ED 방법이
...
실무: **`"sa"` 로 시작한다** (기본값). 이후 민감도 점검을 위해
