...
ultimate* 까지는 *외삽* 이 필요. `fit_tail()` 함수 family 도입 예정 —
*Sherman 1984* 의 log-linear curve (exponential / inverse power /
Weibull) 와 *Clark 2003* 의 parametric growth curve (loglogistic /
Weibull MLE) 가 *하나의 진입점에서 method 인자로 선택*:
