...
Order: `c("lr", "loss_ata", "premium_ata", "loss_ed", "premium_ed", "loss", "premium")` — cleanest to riskiest.
...
column plus a `breakpoint` Date column; `r_all$labels` likewise gains the
