...
test_that("as_triangle accepts a zero-row data.frame and returns empty Triangle", {
  ...
  expect_no_error(tri <- as_triangle(exp_empty, groups = "coverage", cohort = "uy_m", calendar = "cy_m", loss = "incr_loss", premium = "incr_premium"))
...
test_that("as_triangle on a single cohort succeeds", {
  ...
  tri <- as_triangle(single, groups = "coverage", cohort = "uy_m", calendar = "cy_m", loss = "incr_loss", premium = "incr_premium")
  expect_s3_class(tri, "Triangle")
...
test_that("as_triangle on a single group succeeds", {
  ...
  tri <- as_triangle(one_grp, groups = "coverage", cohort = "uy_m", calendar = "cy_m", loss = "incr_loss", premium = "incr_premium")
  expect_s3_class(tri, "Triangle")
...
test_that("as_triangle propagates NA loss without erroring", {
  ...
  expect_no_error(tri <- as_triangle(exp_na, groups = "coverage", cohort = "uy_m", calendar = "cy_m", loss = "incr_loss", premium = "incr_premium"))
  expect_s3_class(tri, "Triangle")
...
test_that("as_triangle with cohort = 'uy_q' (Q grain) succeeds", {
  ...
  tri_q <- as_triangle(exp, groups = "coverage",
                          cohort = "uy_q", calendar = "cy_q", loss = "incr_loss", premium = "incr_premium")
...
test_that("as_triangle with cohort = 'uy_h' (H grain) succeeds", {
  ...
  tri_h <- as_triangle(exp, groups = "coverage",
                          cohort = "uy_h", calendar = "cy_h", loss = "incr_loss", premium = "incr_premium")
...
test_that("as_triangle with cohort = 'uy' (Y grain) succeeds", {
  ...
  tri_y <- as_triangle(exp, groups = "coverage",
                          cohort = "uy", calendar = "cy", loss = "incr_loss", premium = "incr_premium")
...
test_that("as_calendar with calendar = 'cy_q' returns Calendar quarter", {
  ...
  cal_q <- as_calendar(as_triangle(exp, groups = "coverage", cohort = "uy_q", calendar = "cy_q", loss = "incr_loss", premium = "incr_premium"))
