...
[`bootstrap()`](https://seokhoonj.github.io/lossratio-r/reference/bootstrap.md)
과 worker 적합
함수([`fit_sa()`](https://seokhoonj.github.io/lossratio-r/reference/fit_sa.md),
...
|----|----|----|
| `"analytical"` | 없음 — Mack(1993) MSEP closed-form, 시뮬레이션 없음 | 빠르고 분포 가정 없는 SE; [`bootstrap.Triangle()`](https://seokhoonj.github.io/lossratio-r/reference/bootstrap.md) 의 default |
