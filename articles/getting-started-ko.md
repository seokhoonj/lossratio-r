...
| 빌더 | 출력 객체 | 차원 | 사용 시점 |
|----|----|----|----|
| [`as_triangle()`](https://seokhoonj.github.io/lossratio/reference/as_triangle.md) | `Triangle` | 코호트 x dev (2D) | SA, ED, CL 예측 |
| [`as_calendar()`](https://seokhoonj.github.io/lossratio/reference/as_calendar.md) | `Calendar` | 달력 기간 (1D) | 달력 추세, 대각선 효과 |
...
도움말([`?plot.CLFit`](https://seokhoonj.github.io/lossratio/reference/plot.CLFit.md)
등)을 참고한다.
