...
/* =============================================================================
 * Section 5 -- ED-paradigm cell-residual kernel (Phase 1, fixed exposure)
 *
 ...
 *   bootstrap_refit_gstar         <-> bootstrap_refit_fstar
 *   bootstrap_fwd_proj_ed_and_clip <-> bootstrap_fwd_proj_and_clip
 *   bootstrap_fwd_sim_ed_cell      <-> bootstrap_fwd_sim_cell
 *
 ...
 */
static void bootstrap_refit_gstar(
    const double *cum,
 ...
 *
 *   ED additive Stage-2 process noise. Mirror of bootstrap_fwd_sim_cell
 ...
 *     (d) Refit g*_k per link  -> bootstrap_refit_gstar (ED, additive).
...
SEXP bootstrap_kernel_ed_cell(
  ...
  bootstrap_refit_gstar(cum, exposure_proj, link_to_idx, g_hat_vec,
