...
| 인수 기준 변경 등 구조적 변화 | **[`detect_regime()`](https://seokhoonj.github.io/lossratio-r/reference/detect_regime.md)** + `loss_regime` / `premium_regime` 인자 — 변화 이전 코호트를 자동으로 분리 |
| “이 fit 이 얼마나 맞나?” 검증 | **[`backtest()`](https://seokhoonj.github.io/lossratio-r/reference/backtest.md)** — 최근 N 대각선을 빼고 적합한 뒤 actual 과 비교 |
...
| 함수 | 역할 |
|----|----|
| [`as_triangle()`](https://seokhoonj.github.io/lossratio-r/reference/as_triangle.md) | long-format 데이터 → `Triangle` (코호트 × dev) |
| `fit_ratio(method = "ed" / "cl" / "sa")` | 손해율 적합 — *통합 인터페이스* (loss + premium 합성) |
| [`fit_loss()`](https://seokhoonj.github.io/lossratio-r/reference/fit_loss.md) / [`fit_premium()`](https://seokhoonj.github.io/lossratio-r/reference/fit_premium.md) | 역할별 디스패처 — 단일 측 (SE / CI 포함) |
| [`fit_cl()`](https://seokhoonj.github.io/lossratio-r/reference/fit_cl.md) / [`fit_ed()`](https://seokhoonj.github.io/lossratio-r/reference/fit_ed.md) | 단일 stage (chain ladder / exposure-driven) |
| [`fit_ata()`](https://seokhoonj.github.io/lossratio-r/reference/fit_ata.md) / [`fit_intensity()`](https://seokhoonj.github.io/lossratio-r/reference/fit_intensity.md) | link 단계 진단 — 곱셈형 / 덧셈형 |
| [`detect_maturity()`](https://seokhoonj.github.io/lossratio-r/reference/detect_maturity.md) | ATA 인자가 수렴하는 dev 위치 |
| [`detect_regime()`](https://seokhoonj.github.io/lossratio-r/reference/detect_regime.md) | 코호트 축 구조적 변화 탐지 |
| [`detect_convergence()`](https://seokhoonj.github.io/lossratio-r/reference/detect_convergence.md) | 예측 손해율이 갱신을 멈추는 시점 |
| [`backtest()`](https://seokhoonj.github.io/lossratio-r/reference/backtest.md) | 대각선 hold-out 으로 fit 검증 (target = ratio/loss/premium) |
| [`plot()`](https://rdrr.io/r/graphics/plot.default.html) / [`plot_triangle()`](https://seokhoonj.github.io/lossratio-r/reference/plot_triangle.md) | S3 generic — 객체 클래스로 dispatch |
...
| [`as_triangle()`](https://seokhoonj.github.io/lossratio-r/reference/as_triangle.md) 인자 | 의미 | 예시 |
|----|----|----|
